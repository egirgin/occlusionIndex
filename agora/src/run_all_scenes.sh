...
#python main.py brushifyforest torso_subset
#python main.py brushifygrasslands torso_subset
#python main.py construction torso_subset
#python main.py flowers torso_subset
#python main.py hdri_50mm torso_subset
